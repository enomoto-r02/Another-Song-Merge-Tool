...
namespace Another_Song_Merge_Tool.Util
{
    public static class ToolUtil
    {
        ...
        {
            FileUtil.WriteFile_UTF_8_NO_BOM(LOG_PREFIX + "[Debug] " + str, FILE_LOG, true);
        }

        public static void InfoLog(string str)
        {
            FileUtil.WriteFile_UTF_8_NO_BOM(LOG_PREFIX + "[Infomation] " + str, FILE_LOG, true);
        }

        public static void WarnLog(string str)
        {
            FileUtil.WriteFile_UTF_8_NO_BOM(LOG_PREFIX + "[Warning] " + str, FILE_LOG, true);
        }
